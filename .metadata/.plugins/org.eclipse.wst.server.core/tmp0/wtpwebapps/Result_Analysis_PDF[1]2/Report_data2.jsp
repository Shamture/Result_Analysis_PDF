	...
	<body>
					...
					<div class="12u">
						...
						<header id="header">
							...
							<nav id="nav">
								...
								<a href="Report_data.jsp" >class wise</a>
		...
		<div id="main">
			<div class="container">
				<div class="row">
					<div class="12u">
						<form action="./gen_report_data2" method="post" class="form">
					<br>
				<div class="row">			
					...
					<div class="12u" align="center">
							<input type="text" id="resultid" name="resultid" " class="textbox" placeholder="Enter %" required="required"></input>
				
						   <select id="resultid" name="resultop" " class="textbox">
							   	<option selected="selected" style="color: red;" value=">=">Select Operation</option>
								<option value=">=">></option>										
								<option value=">">>=</option>										
								<option value="<="><=</option>										
								<option value="<"><</option>										
